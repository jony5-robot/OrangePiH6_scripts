...
if [ $OPTION = "0" -o $OPTION = "0" ]; then
	...
	DISTRO=$TMP_DISTRO
        ...
        if [ -d $ROOT/output/${DISTRO}_rootfs_${PLATFORM}_${TMP_TYPE} ]; then
                ...
                if [ $OP_ROOTFS = "0" ]; then
                        sudo cp -rf $ROOT/output/${DISTRO}_rootfs_${PLATFORM}_${TMP_TYPE} $ROOT/output/tmp
			...
			sudo rm -rf $ROOT/output/${DISTRO}_rootfs_${PLATFORM}_${TMP_TYPE}
